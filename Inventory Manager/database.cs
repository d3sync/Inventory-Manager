...
namespace Inventory_Manager
{
    ...
    {
        //string sql = "";
        public SQLiteConnection m_dbConnection = new SQLiteConnection("Data Source=MyDatabase.sqlite;Version=3;");
        public database()
        {
        ...
        public void initializeDB()
        {
            ...
            this.NonQuery("CREATE TABLE IF NOT EXISTS Companies (id INTEGER PRIMARY KEY AUTOINCREMENT,company TEXT NOT NULL UNIQUE)");
